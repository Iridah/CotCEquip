...
<aside>
<img src="Stia/Townfolks_Support.png" alt="Stia/Townfolks_Support.png" width="40px" /> **“Incidental Recovery (All)”**
After performing an action, restore HP of Entire Front Row (amount: 10% of their max HP) and grant them 1 Cheer On Point.

<aside>
<img src="Stia/Townfolks_Support.png" alt="Stia/Townfolks_Support.png" width="40px" /> **“Incidental Recovery (All)” (6★)**
After performing an action, restore HP of **All Allies** (amount: 10% of their max HP), raise their Damage Limit by 10,000 (turns: 2) and grant them 1 Cheer On Point.
...
<aside>
<img src="Stia/Phys_Atk_Boost.png" alt="Stia/Phys_Atk_Boost.png" width="40px" /> **(1★)**
Grant All Allies effects based on own Cheer On Points.
·3+: Raise Phys. Atk. by 15%.
·6+: Also raise the limit of Sword, Axe, Bow and Staff damage from support skills and equipment effects to 60%.
·9+: Also raise their Damage Limit by 50,000.

</aside>

<aside>
<img src="Stia/Support-Points.jpg" alt="Stia/Support-Points.jpg" width="40px" /> **(3★)**
After a summoned ally uses their skill, cure status ailments of All Allies (including Charm, Comatose and Stillness), grant them immunity to some status ailments (turns: 2) and gain 3 Cheer On Points.
...
<aside>
<img src="Cassia/Tenacity_Points.png" alt="Cassia/Tenacity_Points.png" width="40px" /> Fightning Spirit: BP does not decrease (even during consumption/with some exceptions). *Effects that require BP will still be activated.
...
Lower Phys. Atk. and Phys. Def. of Single Foe by 15% (turns: 2-5 based on Boost Lv.). [18 SP]
...
Deal Phys. Axe damage to All Foes (potency: 150). Exploits Staff, Tome and Wind weaknesses (damage calculation based on Phys. Axe attack). [39 SP]
...
Deal Phys. Axe damage to Random Foe 6 time(s) (potency: 6x40). Exploits Staff, Tome and Wind weaknesses (damage calculation based on Phys. Axe attack). [91 SP]

</aside>

<aside>
<img src="notion://custom_emoji/2482af5e-3bb7-4af8-a110-df4150e44521/12bebbc6-5396-80f4-87cd-007ac0e33883" alt="notion://custom_emoji/2482af5e-3bb7-4af8-a110-df4150e44521/12bebbc6-5396-80f4-87cd-007ac0e33883" width="40px" /> **(3★)**
Grant Entire Front Row automatic HP recovery (potency: 150/turns: 2-5 based on Boost Lv.) and grant effects based on own Cheer On Points. [80 SP]
·3+: Reaches All Allies.
·6+: Also restore their SP (amount: 5% of target’s max SP).
·9+: Also restore 1 BP.
...
Deal Phys. Axe damage to All Foes 4 time(s) (potency: 4x35) and lower Phys. Res. by 15% (turns: 2). Exploits Staff, Tome and Wind weaknesses (damage calculation based on Phys. Axe attack). At Max Boost: Absorb 1% of damage dealt as SP. [121 SP]

**Lv.96 |** SP Saver: 121→97
...
Deal Phys. Axe damage to Single Foe (potency: 260). Exploits Staff, Tome and Wind weaknesses (damage calculation based on Phys. Axe attack). At Max Boost: Summon again the last summoned ally in battle. [54 SP]
...
Act faster during turn and restore HP of Entire Front Row (potency: 205). At Max Boost: Summon again the last summoned ally in battle. [78 SP]
...
<aside>
<img src="notion://custom_emoji/2482af5e-3bb7-4af8-a110-df4150e44521/12bebbc6-5396-8043-803a-007ae9e1eaea" alt="notion://custom_emoji/2482af5e-3bb7-4af8-a110-df4150e44521/12bebbc6-5396-8043-803a-007ae9e1eaea" width="40px" /> **“Wholehearted Support” (Lv. 1→10→20)**
Act faster during turn, grant All Allies automatic SP recovery (amount: 5% of max SP), raise their BP recovery by 1 and their Axe damage by **5%→10%→15%** (turns: 3).
...
<aside>
<img src="Stia/Captura_de_Pantalla_2026-01-26_a_las_10.27.46.png.png" alt="Stia/Captura_de_Pantalla_2026-01-26_a_las_10.27.46.png.png" width="40px" /> **(EX)**
Act faster during turn and raise potency of All Allies by 50% (turns: 2-5 based on Boost Lv./Turns cannot be extended/Does not stack with effects of the same type). Also grant Self a special effect that makes summoned allies to act twice and not consume summoned ally uses neither ally summons per battle for the next 1-4 times based on Boost Lv..
...
<aside>
<img src="Molrusso%20EX/Awakening_IV.png" alt="Molrusso%20EX/Awakening_IV.png" width="40px" /> **“Architect’s Toolbox”**
·60 P.Atk, 60 P.Def, 700 HP
·Start of battle: Raise Damage Limit of All Allies by 50,000 (turns: 3)
...
![Stia.png](Stia/Stia.png)

## Character Trailer

[https://youtu.be/BR2UTPNXQf4](https://youtu.be/BR2UTPNXQf4)