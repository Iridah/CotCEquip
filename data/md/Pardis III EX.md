...
<aside>
<img src="Pardis%20III%20EX/G2vBk_XbIAAuDj4.jpg" alt="Pardis%20III%20EX/G2vBk_XbIAAuDj4.jpg" width="40px" /> **“Sceptre of the Holy King”**
“Attack” action becomes Elem. Light damage. Exploits Ice and Wind weakness (damage calculation based on Elem. Light attack). Additionally, gain the ability to exploit Ice and Wind weakness with some elemental attacks (damage calculation based on original attack) and grant Self ability to trigger critical hits when using elemental attacks.

</aside>

<aside>
<img src="Pardis%20III%20EX/Elem_atk_Boost.png" alt="Pardis%20III%20EX/Elem_atk_Boost.png" width="40px" /> **(1★)**
Raise Elem. Atk. and Light damage of Self by 20% and Damage Limit by 200,000. Also raise the limit of Elem. Atk. and Light damage of Self from battle skills and support skills and equipment effects to 50%.

</aside>

<aside>
<img src="Pardis%20III%20EX/Phys_Atk_Boost.png" alt="Pardis%20III%20EX/Phys_Atk_Boost.png" width="40px" /> **(3★)**
When in front row: Raise Phys. Atk. and Elem. Atk. of Entire Front Row by 15% and reduce received damage by 25% (with some exceptions/Does not stack with effects of the same type). Also grant Entire Back Row automatic SP recovery (amount: 25) and reduce received damage by 50% (with some exceptions/Does not stack with effects of the same type).

<aside>
<img src="Pardis%20III%20EX/Phys_Atk_Boost.png" alt="Pardis%20III%20EX/Phys_Atk_Boost.png" width="40px" /> **(6★)**
When in front row: Raise Phys. Atk. and Elem. Atk. of Entire Front Row by 15%, raise the limit of Phys. Atk. and Elem. Atk. from battle skills to 50% and reduce received damage by 25% (with some exceptions/Does not stack with effects of the same type). Also grant Entire Back Row automatic SP recovery (amount: 25) and reduce received damage by 50% (with some exceptions/Does not stack with effects of the same type).
...
Deal Elem. Light damage to Single Foe 2 time(s) (potency: 2x90) and lower Elem. Def. by 10% (turns: 2). [34 SP]
...
Deal Elem. Light damage to All Foes 2 time(s) (potency: 2x70) and also raise Phys. Atk. and Elem. Atk. of Entire Front Row by 10% (turns: 2). [58 SP]
...
Deal Elem. Light damage to Random Foe 3 time(s) (potency: 3x65) and lower Light Res. by 15% with every attack (turns: 2). [51 SP]
...
Raise Light damage of Entire Front Row by 20% (turns: 2-5 based on Boost Lv.). At Max Boost: Also fill their Ultimate Technique gauge by 50%. [55 SP]
...
Deal Elem. Light damage to Single Foe 4 time(s) (potency: 4x45) and lower Phys. Atk. and Elem. Atk. by 20% (turns: 2). [72 SP]
...
From the turn after this skill is used, restore HP of Entire Front Row (potency: 205) at the beginning of every turn (turns: 2-5 based on Boost Lv.). If the user is in front row during the healing, also restore 1 BP and cure status ailments of targets. [123 SP]
...
Deal Elem. Light damage to All Foes 3 time(s) (potency: 3x65) and raise Phys. Atk. and Elem. Atk. of Entire Front Row by 15% (turns: 2). At Max Boost: Also grant HP Barrier (amount: 1000/Does not stack). [107 SP]

**Lv.99 |** SP Saver: 107→86

</aside>

<aside>
<img src="notion://custom_emoji/2482af5e-3bb7-4af8-a110-df4150e44521/12bebbc6-5396-80a2-8cca-007a3350e512" alt="notion://custom_emoji/2482af5e-3bb7-4af8-a110-df4150e44521/12bebbc6-5396-80a2-8cca-007a3350e512" width="40px" /> **(5★)**
Deal Elem. Light damage to Single Foe (potency: 530). Ignores effects that completely dodge or block attacks. Raise Damage Limit of this skill by 200,000. [300 SP]
...
<aside>
<img src="notion://custom_emoji/2482af5e-3bb7-4af8-a110-df4150e44521/12bebbc6-5396-80f9-b38d-007a8e50835c" alt="notion://custom_emoji/2482af5e-3bb7-4af8-a110-df4150e44521/12bebbc6-5396-80f9-b38d-007a8e50835c" width="40px" /> **“Holy King’s Command” (Lv. 1→10→20)**
Act faster during turn, raise potency of Single Ally by 100% (turns: 1/Turns cannot be extended/Does not stack with effects of the same type) and Damage Limit by **10,000→50,000→100,000** (turns: 1). If targeting Self, the duration of Potency Up and Damage Limit Up becomes 3 turns.

<aside>
<img src="notion://custom_emoji/2482af5e-3bb7-4af8-a110-df4150e44521/137ebbc6-5396-80a2-a199-007a067e9993" alt="notion://custom_emoji/2482af5e-3bb7-4af8-a110-df4150e44521/137ebbc6-5396-80a2-a199-007a067e9993" width="40px" />

When activated at 200% Ultimate Technique gauge:
Potency Up effect is 150% instead.
...
Restore SP of All Allies (amount: 50-150 based on Boost Lv.), raise Elem. Atk. of Self by 20% (turns: 3-6 based on Boost Lv.) and grant Self the ability to trigger attacking battle skills 3 times (times: 2/Additional instances do not cost SP).
...
<aside>
<img src="Molrusso%20EX/Awakening_IV.png" alt="Molrusso%20EX/Awakening_IV.png" width="40px" /> **“Crown of a Great King”**
·-40 P.Def, 300 E.Atk, -40 E.Def, -30 Spd
·Grant Damage Limit Up (effect: 100,000)
·When in front row: Lower Light Res. of all enemies by 10%
...
![Pardis-III-EX.png](Pardis%20III%20EX/Pardis-III-EX.png)

## Character Trailer

[https://youtu.be/OcMj-D4klpk](https://youtu.be/OcMj-D4klpk)